...
#include <stdlib.h>
#include "vectors.h"
// [rc4l] Dropped upstream's quaternion.h include and multQuaternion() -- zero call sites in the ported backend; reinstate with TVector4 if bone-animated models are ported.
#include <math.h>
