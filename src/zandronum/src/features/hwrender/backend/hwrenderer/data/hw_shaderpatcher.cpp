...
#include "zx_usershader.h" // [rc4l] usershaders lives here rather than in a ported textures.h.
#include "textures.h"
...
{
	{"Default",	"shaders/hwrender/func_normal.fp", "shaders/hwrender/material_normal.fp", ""},
	{"Warp 1",	"shaders/hwrender/func_warp1.fp", "shaders/hwrender/material_normal.fp", ""},
	{"Warp 2",	"shaders/hwrender/func_warp2.fp", "shaders/hwrender/material_normal.fp", ""},
	{"Specular", "shaders/hwrender/func_spec.fp", "shaders/hwrender/material_specular.fp", "#define SPECULAR\n#define NORMALMAP\n"},
	{"PBR","shaders/hwrender/func_pbr.fp", "shaders/hwrender/material_pbr.fp", "#define PBR\n#define NORMALMAP\n"},
	{"Paletted",	"shaders/hwrender/func_paletted.fp", "shaders/hwrender/material_nolight.fp", "#define PALETTE_EMULATION\n"},
	{"No Texture", "shaders/hwrender/func_notexture.fp", "shaders/hwrender/material_normal.fp", "#define NO_LAYERS\n"},
	{"Basic Fuzz", "shaders/hwrender/fuzz_standard.fp", "shaders/hwrender/material_normal.fp", ""},
	{"Smooth Fuzz", "shaders/hwrender/fuzz_smooth.fp", "shaders/hwrender/material_normal.fp", ""},
	{"Swirly Fuzz", "shaders/hwrender/fuzz_swirly.fp", "shaders/hwrender/material_normal.fp", ""},
	{"Translucent Fuzz", "shaders/hwrender/fuzz_smoothtranslucent.fp", "shaders/hwrender/material_normal.fp", ""},
	{"Jagged Fuzz", "shaders/hwrender/fuzz_jagged.fp", "shaders/hwrender/material_normal.fp", ""},
	{"Noise Fuzz", "shaders/hwrender/fuzz_noise.fp", "shaders/hwrender/material_normal.fp", ""},
	{"Smooth Noise Fuzz", "shaders/hwrender/fuzz_smoothnoise.fp", "shaders/hwrender/material_normal.fp", ""},
	{"Software Fuzz", "shaders/hwrender/fuzz_software.fp", "shaders/hwrender/material_normal.fp", ""},
	{nullptr,nullptr,nullptr,nullptr}
};

const FEffectShader effectshaders[] =
{
	{ "fogboundary", "shaders/hwrender/main.vp", "shaders/hwrender/fogboundary.fp", nullptr, nullptr, "#define NO_ALPHATEST\n" },
	{ "spheremap", "shaders/hwrender/main.vp", "shaders/hwrender/main.fp", "shaders/hwrender/func_normal.fp", "shaders/hwrender/material_normal.fp", "#define SPHEREMAP\n#define NO_ALPHATEST\n" },
	{ "burn", "shaders/hwrender/main.vp", "shaders/hwrender/burn.fp", nullptr, nullptr, "#define SIMPLE\n#define NO_ALPHATEST\n" },
	{ "stencil", "shaders/hwrender/main.vp", "shaders/hwrender/stencil.fp", nullptr, nullptr, "#define SIMPLE\n#define NO_ALPHATEST\n" },
	{ "dithertrans", "shaders/hwrender/main.vp", "shaders/hwrender/main.fp", "shaders/hwrender/func_normal.fp", "shaders/hwrender/material_normal.fp", "#define NO_ALPHATEST\n#define DITHERTRANS\n" },
};

int ZXFrameBuffer::GetShaderCount()
{
	int i;
