...
// [rc4l] DrawParms is aliased from DCanvas::DrawParms; ours is nested inside DCanvas.
#include "v_draw.h"
struct FColormap;
struct IntRect;
...
public:
	...
	// [rc4l] DObject::OnDestroy is not virtual in our tree, so this cannot override.
	void OnDestroy();
};
