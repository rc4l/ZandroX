...
#include "files.h"			// [rc4l] FileReader for OPLloadBank.
#include "c_cvars.h"		// [rc4l] keep opl_singlevoice as an engine cvar.
...
//----------------------------------------------------------------------------
//
// [rc4l] Load a Doom GENMIDI lump (8-byte "#OPL_II#" header followed by 175
// packed instrument records) into OPLinstruments.
//
//----------------------------------------------------------------------------
...
int musicBlock::OPLloadBank (FileReader &data)
{
	...
	data.Read (OPLinstruments, sizeof(OPLinstruments));
	return 0;
}
...
CVAR (Bool, opl_singlevoice, 0, 0)	// [rc4l] preserved as a cvar from the old MUS driver.
